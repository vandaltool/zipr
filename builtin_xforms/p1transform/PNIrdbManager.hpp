...
public:
    ...
    PNIrdbManager(IRDB_SDK::DatabaseID_t variant_db_id);
    ...
    // Add a stack object
    virtual IRDB_SDK::DatabaseID_t InsertStackObject(
...
protected:
    ...
    std::unique_ptr<IRDB_SDK::VariantID_t>  m_variant_id;

    /// @brief File associated with this table manager
    std::unique_ptr<IRDB_SDK::FileIR_t> m_file_ir;

    /// @brief Functions identified in this variant
    std::map<std::string, IRDB_SDK::Function_t*> m_function_map;
