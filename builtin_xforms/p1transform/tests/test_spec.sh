...
main()
{
	...
	PSOPTS="$rida_flags "  run_test rida     $SPEC/config/ubuntu14.04lts-64bit-withps.cfg "$all_benchmarks"
	PSOPTS="$rida_flags $p1flags "  run_test rida-p1     $SPEC/config/ubuntu14.04lts-64bit-withps.cfg "$all_benchmarks"
	PSOPTS="$rida_flags $mga_flags "  run_test rida-mga     $SPEC/config/ubuntu14.04lts-64bit-withps.cfg "$all_benchmarks"
	PSOPTS="$rida_flags $mgc_flags "  run_test rida-mgc     $SPEC/config/ubuntu14.04lts-64bit-withps.cfg "$all_benchmarks"
	...
	# try si
	PSOPTS="$zipr_flags $siflags "  run_test zipr-p1-si     $SPEC/config/ubuntu14.04lts-64bit-withps.cfg "$all_benchmarks"
	PSOPTS="$rida_flags $siflags "  run_test rida-p1-si     $SPEC/config/ubuntu14.04lts-64bit-withps.cfg "$all_benchmarks"

	# try nos
	PSOPTS="$zipr_flags $noslags "  run_test zipr-nos     $SPEC/config/ubuntu14.04lts-64bit-withps.cfg "$all_benchmarks"
	PSOPTS="$rida_flags $noslags "  run_test rida-nos     $SPEC/config/ubuntu14.04lts-64bit-withps.cfg "$all_benchmarks"

	# try ss
	PSOPTS="$zipr_flags $sslags "  run_test zipr-ss     $SPEC/config/ubuntu14.04lts-64bit-withps.cfg "$all_benchmarks"
	PSOPTS="$rida_flags $sslags "  run_test rida-ss     $SPEC/config/ubuntu14.04lts-64bit-withps.cfg "$all_benchmarks"
