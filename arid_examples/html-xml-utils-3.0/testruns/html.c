...
/* Line 193 of /usr/local/bison/share/bison/yacc.c.  */
#line 199 "html.c"
...
/* Line 213 of /usr/local/bison/share/bison/yacc.c.  */
#line 220 "html.c"
...
{
      16,     0,    -1,    -1,    17,    18,    -1,    18,     4,    -1,
      18,     3,    -1,    18,    19,    -1,    18,    22,    -1,    18,
      23,    -1,    18,     9,    -1,    18,    12,    -1,    18,     1,
      -1,    -1,     5,    20,    13,    -1,     5,    20,    10,    -1,
      21,    20,    -1,    -1,     7,    -1,     7,    14,     7,    -1,
       7,    14,     8,    -1,     6,    13,    -1,    11,     7,     7,
       8,     8,    13,    -1,    11,     7,     7,     8,    13,    -1
};

/* YYRLINE[YYN] -- source line where rule number YYN was defined.  */
static const unsigned char yyrline[] =
{
       0,   111,   111,   111,   115,   116,   117,   118,   119,   120,
     121,   122,   123,   126,   127,   130,   131,   134,   137,   140,
     145,   148,   149
};
#endif
...
{
  "$end", "error", "$undefined", "TEXT", "COMMENT", "START", "END", "NAME", 
  "STRING", "PROCINS", "EMPTYEND", "DOCTYPE", "ENDINCL", "'>'", "'='", 
  "$accept", "start", "@1", "document", "starttag", "attributes", 
  "attribute", "endtag", "decl", 0
};
#endif
...
{
      -7,     8,    -7,    -7,     0,    -7,    -7,    -7,    10,    -3,
      -7,    11,    -7,    -7,    -7,    -7,     5,     3,    10,    -7,
      13,     7,    -7,    -7,    -7,    14,    -7,    -7,    -6,    12,
      -7,    -7
};
...
{
      -3,     5,    29,     6,     7,     8,     9,    30,     3,    10,
      19,    11,    12,    22,    26,    27,    23,    16,    20,    21,
      25,     0,    28,     0,    24,    31
};

static const yysigned_char yycheck[] =
{
       0,     1,     8,     3,     4,     5,     6,    13,     0,     9,
      13,    11,    12,    10,     7,     8,    13,     7,     7,    14,
       7,    -1,     8,    -1,    18,    13
};
...
#line 112 "html.y"
  ...
  case 4:
#line 115 "html.y"
    {handle.comment(data, yyvsp[0].s);}
    break;

  case 5:
#line 116 "html.y"
    {handle.text(data, yyvsp[0].s);}
    break;

  case 9:
#line 120 "html.y"
    {handle.pi(data, yyvsp[0].s);}
    break;
...
#line 121 "html.y"
  ...
  case 13:
#line 126 "html.y"
    {handle.starttag(data,yyvsp[-2].s,yyvsp[-1].p);}
    break;

  case 14:
#line 127 "html.y"
    {handle.emptytag(data,yyvsp[-2].s,yyvsp[-1].p);}
    break;
...
#line 140 "html.y"
  ...
  case 20:
#line 145 "html.y"
    {handle.endtag(data, yyvsp[-1].s);}
    break;

  case 21:
#line 148 "html.y"
    {handle.decl(data, yyvsp[-4].s, yyvsp[-2].s, yyvsp[-1].s);}
    break;

  case 22:
#line 149 "html.y"
    {if (strcasecmp(yyvsp[-2].s, "public") == 0)
					   handle.decl(data, yyvsp[-3].s, yyvsp[-1].s, NULL);
					 else /* "system" */
					   handle.decl(data, yyvsp[-3].s, NULL, yyvsp[-1].s);}
    break;


    }

/* Line 1016 of /usr/local/bison/share/bison/yacc.c.  */
#line 1140 "html.c"

  yyvsp -= yylen;
  yyssp -= yylen;
