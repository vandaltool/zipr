...
echo "p1xform.doxform.sh: issuing cmd: $SECURITY_TRANSFORMS_HOME/tools/spasm/spasm $NEW_ASPRI_FILE $FINAL_BSPRI_FILE"
$SECURITY_TRANSFORMS_HOME/tools/spasm/spasm $NEW_ASPRI_FILE $FINAL_BSPRI_FILE
