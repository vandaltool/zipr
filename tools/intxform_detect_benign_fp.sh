...
echo "intxform: Integer transform on cloned copy"
...
echo "intxform: Generate temporary aspri --> bspri for integer transform"
...
#	echo "intxform: false positives detection activated"
