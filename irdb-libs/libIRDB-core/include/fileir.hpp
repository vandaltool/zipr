...
class FileIR_t : public BaseObj_t, virtual public IRDB_SDK::FileIR_t
{
	public:
		...
		virtual void setAllEhPrograms (const EhProgramSet_t& new_pgms  ) override { eh_pgms=new_pgms; }
	        virtual void setInstructions  (const InstructionSet_t& newInsns) override { insns=newInsns  ; }
	        virtual void removeInstruction(IRDB_SDK::Instruction_t* toDel  ) override ;
