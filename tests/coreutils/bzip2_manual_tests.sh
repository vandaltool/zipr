...
exitcode=$?
$PEASOUP_HOME/tools/manual_test_import.sh --cmd "./bzip2 -k -s -c ls.orig > ls.orig.bz2" --prog bzip2 --infile ls.orig --outfile ls.orig.bz2 --name bzip2.footprint --exitcode $exitcode
...
bzip2 -k -8 -c ls.orig > ls.orig.bz2 
exitcode=$?
$PEASOUP_HOME/tools/manual_test_import.sh --cmd "./bzip2 -k -8 -c ls.orig > ls.orig.bz2" --prog bzip2 --infile ls.orig --outfile ls.orig.bz2 --name bzip2.ls --exitcode $exitcode
