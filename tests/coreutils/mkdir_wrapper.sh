...
test_transform mkdir/p-1
test_transform mkdir/p-2
test_transform mkdir/p-3
test_transform mkdir/p-slashdot
test_transform mkdir/p-thru-slink
test_transform mkdir/p-v
test_transform mkdir/parents
test_transform mkdir/perm
test_transform mkdir/selinux
test_transform mkdir/special-1
test_transform mkdir/t-slash
