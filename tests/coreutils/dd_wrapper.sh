...
cat error1.txt | sed 's/copied, .*,/copied, /g' >tmp
cat tmp >error1.txt
cat error2.txt | sed 's/copied, .*,/copied, /g' >tmp
cat tmp >error2.txt
...
rm -rf  error1.txt error2.txt tmp
...
#dd does not have usage output when provided no arguments
...
test_transform dd/misc
test_transform dd/not-rewound
test_transform dd/reblock
test_transform dd/skip-seek
test_transform dd/skip-seek2
test_transform dd/skip-seek-past-file
test_transform dd/unblock-sync
