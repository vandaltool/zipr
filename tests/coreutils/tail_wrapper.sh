...
#no usage for tail since no args causes tail to hang
...
test_transform tail-2/infloop-1
test_transform tail-2/tail-n0f

test_transform tail-2/proc-ksyms
test_transform tail-2/start-middle
test_transform misc/tail
