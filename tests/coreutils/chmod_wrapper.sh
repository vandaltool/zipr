...
ORIG_BACKUP_NAME=$TOP_LVEL/src/$ORIG_NAME.bak
...
test_transform chmod/no-x
test_transform chmod/c-option
test_transform chmod/equal-x
test_transform chmod/equals
test_transform chmod/inaccessible
test_transform chmod/octal
test_transform chmod/setgid
test_transform chmod/silent
test_transform chmod/thru-dangling
test_transform chmod/umask-x
test_transform chmod/usage
