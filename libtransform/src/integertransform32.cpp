...
void IntegerTransform32::addMaxSaturation(Instruction_t *p_instruction, Register::RegisterName p_reg, const MEDS_InstructionCheckAnnotation& p_annotation, Instruction_t *p_fallthrough)
{
	assert(getFileIR() && p_instruction);
	...
	if (p_annotation.isUnsigned())
	{
		...
		switch (Register::getBitWidth(p_reg))
		{
			...
			case 8:
				...
				break;
			default:
				cerr << "IntegerTransform32::addMaxSaturation(): invalid bit width: " << p_annotation.getBitWidth() << endl;
				break;
		}
	}
	else
...
void IntegerTransform32::addMinSaturation(Instruction_t *p_instruction, Register::RegisterName p_reg, const MEDS_InstructionCheckAnnotation& p_annotation, Instruction_t *p_fallthrough)
{
	assert(getFileIR() && p_instruction);
